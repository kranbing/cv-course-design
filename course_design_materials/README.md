...
本目录用于准备“基于 Transformer 的城市道路场景语义分割复现与边界增强改进”的报告素材。

当前策略是不在本机训练模型，而是采用“论文精读 + 官方代码结构分析 + 公开结果对照 + 可解释模拟实验”的方式完成实验主线。报告中必须明确说明：表格中的复现实验数据为基于论文公开结果、模型结构复杂度和消融假设构造的模拟复现结果，不等同于本机真实训练结果。
